...
# --- MENU: KLASIFIKASI ---
    ...
    with tab_input:
        ...
        with st.form("form_klasifikasi", clear_on_submit=True):
            ...
            with col_ortu1:
                p_ayah_raw = st.selectbox("Pekerjaan Ayah", ["Tidak Bekerja", "Buruh", "Pedagang Kecil", "Peternak", "Wiraswasta", "Karyawan Swasta", "PNS/TNI/POLRI", "Lainnya"])
                g_ayah_raw = st.selectbox("Penghasilan Ayah", ["Tidak Berpenghasilan", "<= Rp. 500.000", "Rp. 500,000 - Rp. 999,999", "Rp. 1,000,000 - Rp. 1,999,999", "Rp. 2,000,000 - Rp. 4,999,999", "Rp. 5,000,000 - Rp. 20,000,000"])
            ...
            with col_ortu2:
                ...
                g_ibu_raw = st.selectbox("Penghasilan Ibu", ["Tidak Berpenghasilan", "<= Rp. 500.000", "Rp. 500,000 - Rp. 999,999", "Rp. 1,000,000 - Rp. 1,999,999", "Rp. 2,000,000 - Rp. 4,999,999", "Rp. 5,000,000 - Rp. 20,000,000"])
